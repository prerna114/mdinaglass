                  ...
                  >
                    ...
                    <div className="col-md-12">
                      <textarea
                        type="text" rows={7}
                        // ref={fieldRef?.state}
                        placeholder="STATE/PROVINCE*" style={{width: 'auto'}}
                        // onChange={(e) => {
                        //   handleText("state", e.target.value);
                        // }}
                        // value={
                      ...
                      {/* <div className="required-text">{error.state}</div> */}
                       ...
                       <p>To choose a shipping address for your gifts, please add an address to your address book first.</p>
                       <p className="ship-p mb-0"><span><input className="inlineInput" type="checkbox" id="shipping" name="shipping-en" data-gtm-form-interact-field-id="1" /></span>I want to specify a shipping address for the gifts (it will be added to your address book)</p>
                   
                        <div className="custom-file-upload">
    <label className="btn btn-upload mb-0" for="fileInput">Choose File...</label>
    <input type="file" id="fileInput"/>
    <span className="file-name" id="fileName">img1.webp</span>
  </div>



                      <h2 className="mt-3 mb-1">Change Photo</h2>
                      <p className="mb-0">Personalise your registry with a profile image. Max. file size 500kb. Formats: .jpg, .png (and any others).</p>

                      <img src="/assets/Bubble.png" alt="Gift Image mb-2" width="150" className="mb-2"/>
                      <h2 className="mt-2">Registry Status</h2>
                      <div className="checkbook-input">
                      <p className="mb-0"><span><input type="radio" className="radio-check" /></span> Public Registry (available to everyone through registry search, and direct access using direct link)</p>
                       <p> <span><input type="radio" className="radio-check" /></span> Public Registry (available to everyone through registry search, and direct access using direct link)</p>
                   </div>
                   </div>
...
<img src="/assets/Bubble.png" alt="Gift Image mb-2" width="150" />
